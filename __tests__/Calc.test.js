...
beforeEach(() => {
  newAge = new NewAge(75, 313, 121, 40, 6)
});

    test('should determine if user has surpassed life expectancy and return how many years they have lived past the expectancy', () => {
      expect(newAge.lifeExpected()).toEqual(2);
    });
